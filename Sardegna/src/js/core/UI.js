...
class GameUI {
    ...
    updateStatoMezzi(mezzoCambiato = null) {
        ...
        const mezzi = allMezzi; // Include all vehicles for now
        ...
        const center = window.selectedCentral || 'SUD';
        const orderMap = {
            NORD: [null], // Solo ospedali senza prefisso
            SUD: [null]   // Solo ospedali senza prefisso
        };
        const order = orderMap[center] || orderMap['SUD'];
