...
class GameUI {
    ...
    updateStatoMezzi(mezzoCambiato = null) {
        ...
        const center = window.selectedCentral || 'SRA'; // Centrale corrente
        ...
        const ospedaliConOccupazione = window.game.hospitals.map(h => {
            ...
            const nameA = h.nome || '';
            if (nameA.startsWith('(SRA)')) ospedalecentral = 'SRA';
            else if (nameA.startsWith('(SRL)')) ospedalecentral = 'SRL';
            else if (nameA.startsWith('(SRM)')) ospedalecentral = 'SRM';
            else if (nameA.startsWith('(SRP)')) ospedalecentral = 'SRP';
        ...
        // Raggruppa ospedali per centrale operativa di Lombardia
